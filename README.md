...
| --- | --- | --- | --- |
| Personal Agent | [`personal-agent-template`](./personal-agent-template) | [vercel-labs/personal-agent-template](https://github.com/vercel-labs/personal-agent-template) | `ec986e5` |
...
| Discord Agent | [`eve-discord-agent-template`](./eve-discord-agent-template) | [benpankow/vercel-discord-gateway-relay](https://github.com/benpankow/vercel-discord-gateway-relay) | `002dfce` |
